  ...
  if (!isConnected) {
    return (
      <div className="flex items-center justify-center flex-1 px-6">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="glass rounded-2xl p-8 max-w-sm w-full text-center border border-blue-500/20">
          ...
          <h2 className="text-xl font-bold text-white mb-2" style={{ fontFamily: "var(--font-display)" }}>Connect as Auditor</h2>
          <p className="text-sm text-slate-500 mb-6">Connect your wallet to access compliance data.</p>
  ...
  return (
    <div className="flex-1 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-white" style={{ fontFamily: "var(--font-display)" }}>Compliance Dashboard</h1>
      ...
      {activeOrgAddress ? (
        ...
        <div className="glass rounded-2xl p-8 max-w-md mx-auto mt-12 border border-blue-500/20">
          <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 bg-blue-500/10">
          ...
          <input
            ...
            className="input-field mb-4 focus:ring-blue-500"
          />
          <button 
